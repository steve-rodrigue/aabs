...
func TestPlatformApplicationSaveAndFindByID(t *testing.T) {
	...
	result, err := fixture.Application.Platforms().FindByID(
		fixture.Context,
		platform.Identifier(),
	)
	if err != nil {
...
func TestPlatformApplicationFindByHandle(t *testing.T) {
	...
	result, err := fixture.Application.Platforms().FindByHandle(
		fixture.Context,
		platform.Handle(),
	)
	if err != nil {
...
func TestPlatformApplicationFind(t *testing.T) {
	...
	result, err := fixture.Application.Platforms().Find(
		fixture.Context,
		0,
		2,
	)
...
func TestPlatformApplicationFindAfter(t *testing.T) {
	...
	all, err := fixture.Application.Platforms().Find(
		fixture.Context,
		0,
		10,
	)
	...
	result, err := fixture.Application.Platforms().FindAfter(
		fixture.Context,
		all[0].Identifier(),
		10,
	)
...
func TestPlatformApplicationCount(t *testing.T) {
	...
	count, err := fixture.Application.Platforms().Count(
		fixture.Context,
	)
	if err != nil {
		t.Fatal(err)

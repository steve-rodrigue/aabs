...
func TestCommunityApplicationSaveAndFindByID(t *testing.T) {
	...
	result, err := fixture.Application.Communities().FindByID(
		fixture.Context,
...
func TestCommunityApplicationFindByHandle(t *testing.T) {
	...
	result, err := fixture.Application.Communities().FindByHandle(
		fixture.Context,
		platform,
		expected.Handle(),
	)
...
func TestCommunityApplicationFind(t *testing.T) {
	...
	result, err := fixture.Application.Communities().Find(
		fixture.Context,
		0,
		2,
	)
...
func TestCommunityApplicationFindAfter(t *testing.T) {
	...
	all, err := fixture.Application.Communities().Find(
		fixture.Context,
		0,
		10,
	)
	...
	result, err := fixture.Application.Communities().FindAfter(
		fixture.Context,
		all[0].Identifier(),
		10,
	)
...
func TestCommunityApplicationFindByPlatform(t *testing.T) {
	...
	result, err := fixture.Application.Communities().FindByPlatform(
		fixture.Context,
		platform,
	)
	if err != nil {
...
func TestCommunityApplicationCount(t *testing.T) {
	...
	count, err := fixture.Application.Communities().Count(
		fixture.Context,
	)
	if err != nil {
		t.Fatal(err)
...
func newTestCommunityPlatformWithValues(
	...
	err = fixture.Application.Platforms().Save(
		fixture.Context,
		platform,
	)
	if err != nil {
...
func newTestCommunityUser(
	...
	err = fixture.Application.Users().Save(
		fixture.Context,
		user,
	)
	if err != nil {
...
func saveCommunities(
	...
	for _, community := range communities {
		err := fixture.Application.Communities().Save(
			fixture.Context,
			community,
		)
		if err != nil {
...
func assertCommunity(
	...
	if result.Platform() == nil ||
		result.Platform().Identifier() != expected.Platform().Identifier() {

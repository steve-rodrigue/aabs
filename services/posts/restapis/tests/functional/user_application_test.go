...
func TestUserApplicationSaveAndFindByID(t *testing.T) {
	...
	result, err := fixture.Application.Users().FindByID(
		fixture.Context,
		user.Identifier(),
	)
	if err != nil {
...
func TestUserApplicationFindByExternalID(t *testing.T) {
	...
	result, err := fixture.Application.Users().FindByExternalID(
		fixture.Context,
		platform,
		expected.ExternalID(),
	)
...
func TestUserApplicationFindByHandle(t *testing.T) {
	...
	result, err := fixture.Application.Users().FindByHandle(
		fixture.Context,
		platform,
		expected.Handle(),
	)
...
func TestUserApplicationFind(t *testing.T) {
	...
	result, err := fixture.Application.Users().Find(
		fixture.Context,
		0,
		2,
	)
...
func TestUserApplicationFindAfter(t *testing.T) {
	...
	all, err := fixture.Application.Users().Find(
		fixture.Context,
		0,
		10,
	)
	...
	result, err := fixture.Application.Users().FindAfter(
		fixture.Context,
		all[0].Identifier(),
		10,
	)
...
func TestUserApplicationCount(t *testing.T) {
	...
	count, err := fixture.Application.Users().Count(
		fixture.Context,
	)
	if err != nil {
		t.Fatal(err)

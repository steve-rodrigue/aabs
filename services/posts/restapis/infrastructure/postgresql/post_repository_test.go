...
func TestPostRepositoryFindByIDWithThreadContent(t *testing.T) {
	...
	if err := fixture.service.Save(fixture.ctx, post); err != nil {
		t.Fatal(err)
	}
...
func TestPostRepositoryFindByIDWithReplyContent(t *testing.T) {
	fixture := newPostRepositoryFixture(t)
...
func TestPostRepositoryFindByIDWithUpdatedPost(t *testing.T) {
	fixture := newPostRepositoryFixture(t)
	...
	if err := fixture.service.Save(fixture.ctx, first); err != nil {
		t.Fatal(err)
	}

	if err := fixture.service.Save(fixture.ctx, second); err != nil {
		t.Fatal(err)
	}
